...
export const metadata: Metadata = {
  ...
  description:
    'تواصل مع فريق ميلادك لأي استفسارات أو اقتراحات أو دعم تقني. نحن هنا لمساعدتك! فريق دعم متميز جاهز للرد على رسائلكم.',
  keywords: ['اتصل بنا', 'دعم فني', 'تواصل مع ميلادك', 'اقتراحات', 'شكاوى'],
  openGraph: {
...
const contactStructuredData = {
  ...
  '@type': 'ContactPage',
  name: 'اتصل بنا - ميلادك',
  description: 'صفحة التواصل مع فريق عمل موقع ميلادك',
  url: 'https://miladak.com/contact',
  mainEntity: {
    '@type': 'Organization',
    name: 'ميلادك',
      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        ...
        <div className="max-w-2xl mx-auto mb-16">
          <div className="relative group">
            ...
            <div className="relative bg-card rounded-2xl p-8 md:p-10 shadow-xl border border-border">

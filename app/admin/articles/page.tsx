        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400">{total} مقال</p>
            </div>
          </div>
        ...
        <div className="bg-gray-900 rounded-2xl p-4 mb-6 border border-gray-800">
          <div className="flex flex-wrap gap-4">
            ...
            <div className="flex-1 min-w-[200px]">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pr-10 pl-4 py-2 rounded-xl border border-gray-700 bg-gray-800 text-white placeholder-gray-500 focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                />
              </div>
            </div>
            ...
            <button
              ...
              className="p-2 rounded-xl border border-gray-700 text-gray-300 hover:bg-gray-700"
            >

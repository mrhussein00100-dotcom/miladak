      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-400">إضافة وتعديل صلاحيات المستخدمين</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          <button
            onClick={loadUsers}
            className="p-3 rounded-xl bg-gray-800 text-gray-300 border border-gray-700 hover:bg-gray-700 transition-all"
            title="تحديث"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-3 rounded-xl bg-gradient-to-r from-purple-500 to-pink-500 text-white font-medium hover:shadow-lg hover:shadow-purple-500/25 transition-all"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="md:col-span-2 relative">
          ...
          <input
            ...
            className="w-full pr-12 pl-4 py-3 rounded-xl bg-gray-800 border border-gray-700 text-white placeholder-gray-500 focus:border-purple-500 focus:outline-none"
          />
        </div>
      ...
      <div className="bg-gray-900 rounded-2xl border border-gray-800 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {ROLES.map((role) => (
            <div
              key={role.value}
              className={`p-4 rounded-xl border ${role.bgColor} border-gray-700`}
            >
              <h4 className={`font-bold mb-2 ${role.color.split(' ')[1]}`}>
                {role.label}
              </h4>

...
// جعل الصفحة ديناميكية بالكامل لتحميل البيانات الجديدة دائماً
...
export default async function ToolsPage() {
  ...
  // إضافة الأدوات الجديدة يدوياً إذا لم تكن موجودة في قاعدة البيانات
  const extraTools: Tool[] = [
    ...
    },
    {
      ...
      title: 'توافق الأبراج',
      description: 'اكتشف نسبة التوافق بين الأبراج بدقة',
      icon: '❤️',
      category_id: 3,
      category_name: 'الأبراج والفلك',
    ...
    },
    {
      ...
      title: 'حاسبة الحب',
      description: 'احسب نسبة الحب بينك وبين شريكك من خلال الأسماء',
      icon: '💘',
      category_id: 3,
      category_name: 'الأبراج والفلك',
    ...
    },
    {
      ...
      slug: 'date-converter',
      title: 'محول التاريخ',
      description: 'حول التاريخ بين الهجري والميلادي بدقة',
      icon: '📅',
      category_id: 1,
      category_name: 'حاسبات التاريخ',
    ...
    },
    {
      ...
      description: 'اكتشف عمرك على كواكب المجموعة الشمسية',
      icon: '🚀',
      category_id: 3,
      category_name: 'الأبراج والفلك',

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-secondary/5">
      <div className="container mx-auto px-4 py-12">
        ...
        >
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-primary to-secondary rounded-3xl mb-6 shadow-xl">
        ...
        >
          <div className="relative">
            <input
              ...
              className="w-full px-6 py-4 pr-14 border-2 border-input rounded-2xl 
            ...
            <button
              ...
              className="absolute left-2 top-1/2 transform -translate-y-1/2 
                       bg-gradient-to-r from-primary to-secondary p-3 rounded-xl
                            ...
                            {tools.map((result, index) => (
                              ...
                              >
                                <Link
                                  ...
                                  className="block bg-card rounded-xl p-4 shadow-md hover:shadow-lg transition-all duration-300 border border-border hover:border-primary/50 transform hover:-translate-y-1"
                                >
                            ...
                            {articles.map((result, index) => (
                              ...
                              >
                                <Link
                                  ...
                                  className="block bg-card rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 border border-border hover:border-secondary/50 transform hover:-translate-y-1"
                                >
                                  {result.image ? (
                                    ...
                                    <div className="h-32 bg-gradient-to-br from-secondary to-accent flex items-center justify-center">
                                      <BookOpen className="w-10 h-10 text-primary-foreground/70" />
                                    </div>
                                  )}
                                  <div className="p-4">
                ...
                {results.map((result, index) => (
                  ...
                  >
                    <Link
                      ...
                      className="block bg-card rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 h-full border border-border hover:border-primary/50 transform hover:-translate-y-1"
                    >
                      {/* صورة أو أيقونة */}
                      <div
                      ...
                      >
                        {result.image ? (
                          ...
                          <BookOpen className="w-16 h-16 text-primary-foreground/70" />
                        )}
                        {/* نوع النتيجة */}
                        <div className="absolute top-3 right-3 px-3 py-1 bg-background/90 rounded-full text-xs font-bold">
                          {result.type === 'tool' ? (
                      ...
                      <div className="p-5">
                        ...
                        {result.category && (
                          <div className="mt-3 inline-block px-3 py-1 bg-muted rounded-full text-xs text-muted-foreground">
                            {result.category}
                          </div>
                        )}
                      </div>
              ...
              <div className="flex flex-wrap justify-center gap-3">
                {[
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-card border border-border rounded-xl text-muted-foreground hover:border-primary/50 hover:text-primary transition-all"
                  >
                    {term}
                  </button>
                ))}

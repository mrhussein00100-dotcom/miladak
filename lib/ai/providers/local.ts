...
// بيانات الأبراج
export const zodiacData: Record<string, any> = {
  الحمل: {
    element: 'ناري',
...
// أحجار الميلاد
export const birthstoneData: Record<number, { name: string; meaning: string }> = {
...
// زهور الميلاد
export const birthFlowerData: Record<number, { name: string; meaning: string }> = {

...
- [ ] 1. Initialize Next.js 15 project with TypeScript
  ...
  - [ ] 1.2 Configure Tailwind CSS with RTL support
  ...
  - [ ] 1.3 Set up project structure
    - Create directories: components/, lib/, types/, hooks/, __tests__/
...
- [ ] 2. Set up database layer
  - [ ] 2.1 Install and configure better-sqlite3
...
- [ ] 5. Implement age calculation logic
  - [ ] 5.1 Create ageCalculations.ts
    - Implement calculateAge function
    - Calculate years, months, days, hours, minutes, seconds
    - _Requirements: 2.1_
  - [ ] 5.2 Write property test for age calculation
    - **Property 1: Age Calculation Accuracy**
    - **Validates: Requirements 2.1**
  - [ ] 5.3 Implement Hijri date conversion
  ...
  - [ ] 5.5 Implement life statistics calculations
...
- [ ] 8. Implement 4-theme system
  ...
  - [ ] 8.4 Create ThemeToggle component
...
- [ ] 9. Create layout components
  - [ ] 9.1 Create RootLayout with RTL support
    - Set lang="ar" dir="rtl"
  ...
  - [ ] 9.2 Create Navbar component
    ...
    - _Requirements: 15.2_
  - [ ] 9.3 Create BottomNav for mobile
...
- [ ] 10. Create base UI components
  ...
  - [ ] 10.2 Create Card component
    - Glassmorphism effect
    - Hover lift animation
    - _Requirements: 13.1.4, 13.2.1-13.2.5_
  - [ ] 10.3 Create Input component
...
- [ ] 11. Build homepage
  ...
  - [ ] 11.2 Create AgeCalculator component
    - Date input with validation
    - Calculate button
    - Error display in Arabic
    - _Requirements: 2.1-2.5_
  - [ ] 11.3 Create ResultsDisplay component
    - Age breakdown cards
    - Animated counters
    - _Requirements: 2.1, 13.1.9_
  - [ ] 11.4 Create LifeStats section
    - Fun statistics display
    - Animated numbers
    - _Requirements: 2.3_
  - [ ] 11.5 Create ZodiacSection
    - Western and Chinese zodiac
    - Icons and descriptions
    - _Requirements: 2.4_
  - [ ] 11.6 Create FeaturedTools section
    - Display popular tools
    - Link to tools page
    - _Requirements: 15.1, 15.4_
  - [ ] 11.7 Create rich content section
...
- [ ] 13. Create API routes
  - [ ] 13.1 Create /api/birthday-info route
    - Accept birth date
    - Return age data, zodiac, historical events
    - _Requirements: 2.1-2.4, 19.1-19.3_
  - [ ] 13.2 Create /api/tools route
    - List all tools by category
    - Support filtering
    - _Requirements: 3.1_
  - [ ] 13.3 Write property test for tools categorization
    - **Property 7: Tools Categorization Completeness**
    - **Validates: Requirements 3.1**
  - [ ] 13.4 Create /api/articles route
    - List articles with pagination
    - Category filtering
    - _Requirements: 4.1_
  - [ ] 13.5 Write property test for article pagination
    - **Property 10: Article Pagination Consistency**
    - **Validates: Requirements 4.1**
  - [ ] 13.6 Create /api/articles/[slug] route
    - Get single article
...
- [ ] 14. Implement calculator tools
  - [ ] 14.1 Create BMI Calculator
  ...
  - [ ] 14.3 Create Calorie Calculator
  ...
  - [ ] 14.5 Create Days Between Calculator
    - Two date inputs
    - Calculate difference
    - _Requirements: 18.9_
  - [ ] 14.6 Write property test for days between
    - **Property 18: Days Between Dates Symmetry**
    - **Validates: Requirements 18.9**
  - [ ] 14.7 Create Day of Week Calculator
    - Date input
    - Return day name in Arabic
    - _Requirements: 18.8_
  - [ ] 14.8 Write property test for day of week
    - **Property 19: Day of Week Consistency**
    - **Validates: Requirements 18.8**
  - [ ] 14.9 Create Birthday Countdown
    - Next birthday calculation
    - Live countdown display
    - _Requirements: 18.2_
  - [ ] 14.10 Write property test for countdown
    - **Property 20: Countdown Timer Accuracy**
    - **Validates: Requirements 18.2, 18.10**

- [ ] 15. Implement remaining tools
  - [ ] 15.1 Create Age in Seconds tool
    - _Requirements: 18.1_
  - [ ] 15.2 Create Event Countdown tool
    - _Requirements: 18.10_
  - [ ] 15.3 Create Celebration Planner tool
    - _Requirements: 18.5_
  - [ ] 15.4 Create Child Age tool
    - _Requirements: 18.6_
  - [ ] 15.5 Create Child Growth tool
    - _Requirements: 18.7_
  - [ ] 15.6 Create Generation Calculator tool
    - _Requirements: 18.11_
  - [ ] 15.7 Create Holidays Calculator tool
    - _Requirements: 18.12_
  - [ ] 15.8 Create Islamic Holidays tool
    - _Requirements: 18.13_
  - [ ] 15.9 Create Life Statistics tool
    - _Requirements: 18.14_
  - [ ] 15.10 Create Pregnancy Stages tool
    - _Requirements: 18.15_
  - [ ] 15.11 Create Relative Age tool
    - _Requirements: 18.16_
  - [ ] 15.12 Create Timezone Calculator tool
...
- [ ] 17. Create Tools listing page
  - [ ] 17.1 Create /tools page with SSG
    - Display tools by category
    - Search and filter functionality
    - _Requirements: 3.1, 5.8_
  - [ ] 17.2 Create tool page template
    - Dynamic [slug] route
    - SEO metadata
    - Related tools section
    - _Requirements: 3.2, 5.2.2_

- [ ] 18. Create Articles system
  - [ ] 18.1 Create /articles page with SSG
    - Article cards with images
    - Category filtering
    - Pagination
    - _Requirements: 4.1, 5.8_
  - [ ] 18.2 Create article page template
    - Dynamic [slug] route
...
- [ ] 19. Implement SEO features
  - [ ] 19.1 Create StructuredData component
  ...
  - [ ] 19.3 Create MetaTags component
    - Title, description, keywords
    - Open Graph, Twitter Cards
    - _Requirements: 5.1_
  - [ ] 19.4 Create Breadcrumbs component
    - Navigation breadcrumbs
    - Structured data integration
    - _Requirements: 5.3.1_
  - [ ] 19.5 Generate sitemaps
    - Main sitemap
    - Tools sitemap
    - Articles sitemap
    - _Requirements: 5.3_
  - [ ] 19.6 Create robots.txt
    - Crawling directives
    - Sitemap references
    - _Requirements: 5.4_
...
- [ ] 20. Implement AdSense integration
  - [ ] 20.1 Create AdSenseSlot component
    - Async loading
    - Responsive ad units
    - _Requirements: 6.1, 6.2_
  - [ ] 20.2 Add ad placements
    - Header, sidebar, in-content positions
    - Clear separation from content
    - _Requirements: 6.3, 6.4_

- [ ] 21. Implement Analytics
  - [ ] 21.1 Create GoogleAnalytics component
    - Page view tracking
    - Event tracking
    - _Requirements: 10.2_
...
- [ ] 22. Optimize mobile experience
  - [ ] 22.1 Implement touch gestures
    - Swipe navigation
    - Pull to refresh
...
- [ ] 29. Prepare for deployment
  - [ ] 29.1 Configure Vercel deployment

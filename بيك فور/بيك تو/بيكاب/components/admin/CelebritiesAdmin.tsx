        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600">مشاهير اليوم</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-600">
                {new Set(celebrities.map((c) => c.profession)).size}
              </div>
              <div className="text-sm text-gray-600">مهن مختلفة</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-green-600">
                {Math.min(...celebrities.map((c) => c.birth_year)) || 0}
              </div>
              <div className="text-sm text-gray-600">أقدم مولود</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-orange-600">
                {selectedDay}/{selectedMonth}
              </div>
              <div className="text-sm text-gray-600">التاريخ المحدد</div>
            </div>
          </div>
        </CardContent>
      </Card>

      ...
      <section className="relative overflow-hidden pt-20 pb-12">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <motion.p
              className="text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-600 dark:from-purple-400 dark:to-pink-400 mb-4"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className={`glass p-6 rounded-2xl border-2 border-white/20 bg-gradient-to-br ${group.color} bg-opacity-5`}
              >
                <div className="flex items-center gap-3 mb-6">
                  <span className="text-4xl">{group.icon}</span>
                  <h3 className="text-xl font-bold">{group.ageGroup}</h3>
                </div>
                <div className="space-y-4">

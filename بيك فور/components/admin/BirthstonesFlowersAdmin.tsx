        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600">أحجار محددة</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-pink-600">
                {birthFlowers.length}
              </div>
              <div className="text-sm text-gray-600">زهور محددة</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-green-600">
                {12 - birthstones.length}
              </div>
              <div className="text-sm text-gray-600">أحجار مفقودة</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-orange-600">
                {12 - birthFlowers.length}
              </div>
              <div className="text-sm text-gray-600">زهور مفقودة</div>
            </div>
          </div>
        </CardContent>
      </Card>

        ...
        <div className="space-y-3">
          ...
          >
            <option value="sona-v6">
              🌟 SONA 6.0 (المنسق الذكي) - مُوصى به
            </option>
            ...
            <option value="sona-v4">SONA v4 (محلي متقدم) 🚀</option>
          </select>
          <p className="text-xs text-gray-500 dark:text-gray-400">
            {settings.provider === 'sona-v6' &&
              'منسق ذكي يختار أفضل مزود تلقائياً (مُوصى به)'}
            {settings.provider === 'groq' && 'سرعة عالية في المعالجة'}
            {settings.provider === 'gemini' && 'جودة عالية في النتائج'}
            {settings.provider === 'cohere' && 'متوازن بين السرعة والجودة'}
            {settings.provider === 'huggingface' && 'نماذج مفتوحة المصدر'}
            {settings.provider === 'sona-v4' &&
              'نظام محلي متقدم بدون API خارجي'}
          </p>
        </div>
      </div>
      ...
      <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700">
        ...
        <div className="flex flex-wrap gap-2 mb-3">
          ...
          <span className="px-3 py-1 bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300 rounded-full text-xs font-medium">
            {settings.provider === 'sona-v6' && '🌟 SONA 6.0'}
            ...
            {settings.provider === 'sona-v4' && 'SONA v4 🚀'}
          </span>
        </div>

        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          ...
          {canSmartFormat && (
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-lg bg-purple-100 dark:bg-purple-900/30 hover:bg-purple-200 dark:hover:bg-purple-900/50 text-purple-700 dark:text-purple-300 transition-all duration-200 font-medium disabled:opacity-50"
            >
              {isSmartFormatting ? (
              ...
              <span>{isSmartFormatting ? 'تنسيق...' : 'تنسيق ذكي'}</span>
            </button>
          )}

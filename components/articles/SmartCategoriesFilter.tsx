  ...
  return (
    ...
    >
      ...
      {overflowCategories.length > 0 && (
        <div ref={dropdownRef} style={{ position: 'relative', zIndex: 46 }}>
          <Button
            variant="outline"
            size="sm"
...
function OverflowDropdown({
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: -10 }}
      className="absolute top-full right-0 mt-2 w-64 bg-white dark:bg-gray-900 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700"
      style={{ zIndex: 47, position: 'absolute' }}
    >
